                                                                ...
                                                                const FPostProcessingInputs& Inputs)
{
	...
	const FIntVector GroupSize = FComputeShaderUtils::GetGroupCount(ThreadCount, FIntPoint(32, 32));

	// TShaderMapRef<FColourReplaceCS> ComputeShader(GlobalShaderMap);
	// FComputeShaderUtils::AddPass(GraphBuilder, FRDGEventName(TEXT("Colour Replace Compute Pass")), ERDGPassFlags::Compute, ComputeShader, InputParams, GroupSize);
}
